        ...
        bg-[#F9F9FF] md:items-center'>
            ...
            <div className='mt-3 text-lg flex flex-col md:flex-row md:justify-around md:items-center'>
                ...
                <div className='flex flex-col md:flex-row '>
                    <Link to='/statistics' className='mr-0 md:mr-6 mb-2 md:mb-0 hover:text-fuchsia-800 hover:text-xl'>Statistics</Link>
                    <Link to='/appliedJobs' className='mr-0 md:mr-6 mb-2 md:mb-0 hover:text-fuchsia-800 hover:text-xl'>Applied Jobs</Link>
                    <Link to='/blog' className='mr-0 md:mr-6 mb-2 md:mb-0 hover:text-fuchsia-800 hover:text-xl'>Blogs</Link>
                </div>
